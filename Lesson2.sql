...
SELECT web_events.channel, web_events.occurred_at, web_events.account_id,
accounts.name
FROM web_events 
JOIN accounts
...
SELECT s.name reps, a.name account, r.name region
FROM accounts a
JOIN sales_reps s
...
SELECT o.occurred_at occurred_at, a.name account_name, o.total total, o.total_amt_usd total_amt
FROM orders o
JOIN accounts a
ON o.account_id = a.id
